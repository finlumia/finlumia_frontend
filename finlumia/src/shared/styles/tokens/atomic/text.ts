...
const createThemeTextTokens = (foundation: typeof lightFoundation | typeof darkFoundation) => ({
  primary: {
...
export const textTokens = {
  base: textBase,
  light: createThemeTextTokens(lightFoundation),
  dark: createThemeTextTokens(darkFoundation),
} as const;