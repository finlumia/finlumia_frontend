...
- `src/app/layout.tsx`: layout raiz, metadados e `ThemeProvider`.
- `src/app/page.tsx`: rota `/` (landing page).
- Novas rotas: criar pastas em `src/app/` (ex.: `src/app/login/page.tsx`).
